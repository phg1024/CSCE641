...
public:
    ...
    inline PixelType& operator() (size_t colIndex, size_t rowIndex, size_t);
    inline const PixelType& operator() (size_t colIndex, size_t rowIndex, size_t) const;
    ...
    virtual AbstractImage::ImageType getType() const {return _type;}
...
template <class PixelType>
inline PixelType& AbstractImage<PixelType>::operator ()(size_t colIndex, size_t rowIndex, size_t compIndex = 0)
{
...
template <class PixelType>
const PixelType& AbstractImage<PixelType>::operator ()(size_t colIndex, size_t rowIndex, size_t compIndex = 0) const
{    
    assert( colIndex < _width );
    assert( rowIndex < _height );
    assert( compIndex < _stride );
